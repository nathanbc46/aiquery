...
export const aiSettings = mysqlTable('ai_settings', {
  ...
  refineModel: varchar('refine_model', { length: 100 }).notNull().default('gemini-3.1-flash-lite'),
  refineSystemPrompt: text('refine_system_prompt').notNull(),
  generateModel: varchar('generate_model', { length: 100 }).notNull().default('gemini-3.1-flash-lite'),
  generateSystemInstruction: text('generate_system_instruction').notNull(),
  analyzeModel: varchar('analyze_model', { length: 100 }).notNull().default('gemini-2.5-flash'),
  analyzeSystemInstruction: text('analyze_system_instruction').notNull(),
  chatModel: varchar('chat_model', { length: 100 }).notNull().default('gemini-3.1-flash-lite'),
  chatSystemInstruction: text('chat_system_instruction').notNull(),
  optimizeModel: varchar('optimize_model', { length: 100 }).notNull().default('gemini-2.5-pro'),
