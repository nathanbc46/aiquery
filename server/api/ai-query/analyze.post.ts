...
**สำคัญมาก:** หากพบว่ามีข้อมูลสถิติใดที่สามารถจัดกลุ่มและแสดงผลเป็นกราฟได้ (เช่น Pie chart, Bar chart) เพื่อให้เข้าใจง่ายขึ้น ให้คุณสรุปและสร้างกราฟประกอบมาด้วยเสมอ โดยใช้รูปแบบโค้ด Markdown ของ \`\`\`mermaid`;
